...
export const links = [
  { label: "About Us", url: "/iteration3/about-us" },
  { label: "Contact Us", url: "/iteration3/contact-us" },
  { label: "Privacy", url: "/iteration3/privacy" },
  { label: "Terms & Condition", url: "/iteration3/terms" },
  { label: "Advertising Policy", url: "/iteration3/advertising" },
];

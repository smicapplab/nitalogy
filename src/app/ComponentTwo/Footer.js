...
export const links = [
  { label: "About Us", url: "/iteration2/about-us" },
  { label: "Contact Us", url: "/iteration2/contact-us" },
  { label: "Privacy", url: "/iteration2/privacy" },
  { label: "Terms & Condition", url: "/iteration2/terms" },
  { label: "Advertising Policy", url: "/iteration2/advertising" },
];

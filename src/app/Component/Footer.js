        ...
        >
          <Grid container spacing={2}>
            <Grid item md={2}>
              ...
              <ul>
                {pages.map((page) => (
                  <li className="cursor-pointer pt-2 text-gray-400 ml-2" onClick={()=>router.push(page.url)}>
                    {page.label}
                  </li>
                ))}
              </ul>
            ...
            <Grid item md={2}>
              ...
              <ul>
                {links.map((link) => (
                  <li className="cursor-pointer pt-2 text-gray-400 ml-2" onClick={()=>router.push(link.url)}>
                    {link.label}
                  </li>
                ))}
              </ul>
